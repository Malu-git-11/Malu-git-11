...
// MAPA
const prefeituraCoords = [-23.5426, -46.4143];
const map = L.map('map').setView(prefeituraCoords, 14);
...
fetch('./src/data/direitos.json')
    .then(res => res.json())
    .then(data => {
        const container = document.getElementById("conteudo-direitos");
